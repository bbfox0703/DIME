...
### 下載
   ...
   **最新穩定發行版本 DIME v.1.3.610（更新日期: 2026-04-07）**
   ...
   <!-- DOWNLOAD_START -->     
     <details>
     <summary><b>最新開發版本 DIME v1.3.675 (更新日期: 2026-04-09)</b></summary>
   <!-- DOWNLOAD_END -->
...
### 驗證檔案完整性
   ...
   **最新穩定發行版本 SHA-256 CHECKSUM:**
   ...
   <!-- CHECKSUM_START -->
     <details>     
     <summary><b>最新開發版本 DIME v1.3.675 SHA-256 CHECKSUM (更新日期: 2026-04-09)</b></summary>
   
    | 檔案 | SHA-256 CHECKSUM |
    |------|----------------|
    | DIME-Universal.exe | `65770DFA9E994F474548C7E3176078232192DB1D858756B2A7FEABEA82C58251` |
    | DIME-Universal.zip | `A9961FA48B832BF696A823441168653BAB638B6FB9C3E78BD1314C2CDB710DEF` |
    | DIME-64bit.msi | `2F0F30254F990BF240EEB307770A824A663D9636200D53500D5A75576520B8D6` |
    | DIME-32bit.msi | `6E50D2056D1796E5C54A33D66B72867E8FB732FF742E587A8CCD9480020E4C69` |
   <!-- CHECKSUM_END -->
     </details>
