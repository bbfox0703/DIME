...
### 下載
   ...
   **最新穩定發行版本 DIME v.1.3.610（更新日期: 2026-04-07）**
   ...
   <!-- DOWNLOAD_START -->     
     <details>
     <summary><b>最新開發版本 DIME v1.3.686 (更新日期: 2026-04-10)</b></summary>
   <!-- DOWNLOAD_END -->
...
### 驗證檔案完整性
   ...
   **最新穩定發行版本 SHA-256 CHECKSUM:**
   ...
   <!-- CHECKSUM_START -->
     <details>     
     <summary><b>最新開發版本 DIME v1.3.686 SHA-256 CHECKSUM (更新日期: 2026-04-10)</b></summary>
   
    | 檔案 | SHA-256 CHECKSUM |
    |------|----------------|
    | DIME-Universal.exe | `DC147BD11C4B01D01EFCA5A544573717AF2CC50DB909F957075255509B2C84B3` |
    | DIME-Universal.zip | `30E1E902B1D9650A6C137244C8EE832C053B9D47DC12924AF1179B2FB56405E8` |
    | DIME-64bit.msi | `7BF438AC3C34A207922B8044E9841CBD0EE4DBA5D6B11466D8186495F06A5EA5` |
    | DIME-32bit.msi | `A8CCAAF1356DFE0DBA8ED9022AFCC618815E11865CB089481E0C92F9A2C31DD1` |
   <!-- CHECKSUM_END -->
     </details>
